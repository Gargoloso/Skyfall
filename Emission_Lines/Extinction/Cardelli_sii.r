...
data <- read.table("---", header=TRUE) # File with general information for each galaxy.
attach(data)
...
path_oi <- str_c(---,"/lis_sii.res") #creates path to the [S II] 6716,6731 data file for each galaxy.
